...
package Simple2_Args is
   ...
   function Do_String (Arg : String) return Boolean;
   function Do_Unbounded_String (Arg : Unbounded_String) return Boolean;
   function Do_Integer (Arg : Integer) return Boolean;
   function Do_Natural (Arg : Natural) return Boolean;
   function Do_Positive (Arg : Positive) return Boolean;

   ------------------------------------------------------------------------------------------
   --  These show that you can options that have only a Short_Name or only a Long_Name.
   ------------------------------------------------------------------------------------------

   function Do_Short_Name_Only return Boolean;
   function Do_Long_Name_Only return Boolean;
